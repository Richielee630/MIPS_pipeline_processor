module mips_fpga (
    ...
    assign factErr[0] = gpO1[0];
       assign factErr[1] = gpO1[0];
          assign factErr[2] = gpO1[0];
             assign factErr[3] = gpO1[0];
    assign dispSe = gpO1[4];
    assign system_hex = dispSe ? gpO2[31:16]:gpO2[15:0];
    /*
    ...
    */
    ...
    always @ (posedge clk) begin
        case ({switches[8:5]})
            ...
            4'b0100: reg_hex = alu_outM[15:0];
            4'b0101: reg_hex = alu_outM[31:16];
            4'b0110: reg_hex = wd_dmM[15:0];
            4'b1000: reg_hex = pc_current[15:0];
            4'b1001: reg_hex = pc_current[31:16];
            4'b1111: reg_hex = system_hex;
